...
class StringComparator {
    ...
    public int compareStrings(String string1, String string2) {
        ...
        for (int idx = 0; idx < tokens1.length; idx++) {
            ...
            for (int jdx = 0; jdx < tokens2.length; jdx++) {
                ...
                int distance = calculateLevenshteinDistance(matrix, token1, token2, len1, len2);
    ...
    private int calculateLevenshteinDistance(int[][] matrix, String token1,
                                             String token2, int len1, int len2) {
        int cost;
        int distance = 0;
